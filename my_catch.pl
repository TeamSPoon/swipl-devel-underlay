...
p11 :- reset(q11,Cont,Term1), writeln(term1=Term1), writeln(cont=Cont), writeln(end).
q11 :- writeln('before shift'), shift('return value'), trace,writeln('after shift').
/*
?- p11.
before shift
return value
...
p22 :- reset(q22,Cont,Term1), writeln(term1=Term1),  writeln(cont=Cont), call(Cont), writeln(end).
q22 :- writeln('before shift'), shift('return value'), writeln('after shift').
